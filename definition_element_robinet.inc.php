...
class robinetElement extends TIVElement {
  function robinetElement($db_con = false) {
    ...
    $this->_hidden_column = array("id","net_ultrason","observation");
    $this->_hidden_column_sm = array("id","filetage", "filetage_sortie", "net_ultrason","observation","spec_robinet","operations");
